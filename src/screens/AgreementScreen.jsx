...
export default function AgreementScreen() {
  ...
  const handleSendForSignature = () => {
    ...
    alert(`Agreement sent for signature via DocuSign! Patient (${patient?.email || 'email'}) will receive notification via email and SMS.`);
  };
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
          ...
          {(!agreementData.finalized && (isCurrentAgreement || isNewAgreementFromConfig)) ? (
            ...
            <>
              ...
              <div className="mt-6">
                <SignatureStatus
                  sentForSignature={agreementSent || agreementData.sentForSignature}
                  sentDate={state.agreement.sentDate || agreementData.sentDate}
                  signed={agreementData.signed}
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      {agreement.sentForSignature && !agreement.signed && (
                        <span className="px-2 py-1 bg-blue-600 text-white text-xs font-semibold rounded flex items-center gap-1">
